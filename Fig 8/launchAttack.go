...
func attackCID(targetCID string, currentClosest string, peerIdList []string, numberOfSybils int)([]string, []string){
        ...
        for i := 0; i < numberOfSybils; i++ {
                ...
                sybil, sybilkey,privatekey, _ := generateNewKey(currentClosest, targetCIDKey)
